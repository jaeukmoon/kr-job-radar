...
- **토스**: `api-public.toss.im/.../career/job-groups` (Greenhouse 백엔드) — fetch 함수는 있으나 카테고리 신뢰도 검증 전이라 소스에서 제외됨
...
```
fetch_jobs.py     # stdlib-only fetcher (소스 5개 + AI/ML 필터 + first_seen 원장)
